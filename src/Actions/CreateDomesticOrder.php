 ...
 * @property string  $originDirection      hints of the location e.g. in front of drug store K-12, etc (string - can be
 *           empty)
 * @property string  $destinationAddress   destination address
 * @property string  $destinationDirection hints of the location e.g. in front of drug store K-12, etc (string - can be
 *           empty)
 ...
 * @property integer $packageType          package type ID ( 1 for documents; 2 for small packages [DEFAULT]; and 3 for
 ...
 *
 */
class CreateDomesticOrder extends BaseAction
{
